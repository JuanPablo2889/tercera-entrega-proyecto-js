...
function agregarAlCarrito(productoAgregado) {
    ...
    if (encontrado == undefined) {
        ...
        Swal.fire("Nuevo producto agregado al carrito", productoAgregado.nombre, "success");
...
function mostrarEnTabla() {
    ...
    for (const prod of carrito) {
        ...
        $(`#eliminar${prod.id}`).click(function () {
            ...
            carrito[eliminado].cantidad -= 1;
            mostrarEnTabla();
            var cantidadEnCarrito = carrito[eliminado].cantidad;

            //si el carrito no posee productos borramos el mismo
